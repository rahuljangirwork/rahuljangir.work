...
I designed the base and arms in SolidWorks and converted the model to .gltf so that I could use the Three.js library along with [react-three-fiber](https://github.com/pmndrs/react-three-fiber) to display it below. Regular panning, zooming, and rotating controls work in the outlined canvas.
