...
src:
  {
    image:
      {
        path: "/assets/unix-history-screenshot.png",
...
<GeCarousel images={['/assets/linux-setup-screenshot.png', '/assets/linux-setup-screenshot.png', '/assets/linux-setup-screenshot.png']} />
...
![UNIX Shell](assets/unix-shell.png)
...
![Richard Stallman](assets/richard-stallman.png)
...
![UNIX Legacy](assets/unix-legacy.png)
