            ...
            >
                ...
                >
                    <div className="flex items-center mb-3">
                        ...
                        <h3 className="text-md lg:text-lg font-semibold text-palette-2">Profile</h3>
                    </div>
                ...
                >
                    <div className="flex items-center mb-3">
                        ...
                        <h3 className="text-md lg:text-lg font-semibold text-palette-2">Current Activity</h3>
                    </div>
                ...
                >
                    <div className="flex items-center mb-3">
                        ...
                        <h3 className="text-md lg:text-lg font-semibold text-palette-2">Tech Stack</h3>
                    </div>
                ...
                >
                    <div className="flex items-center mb-3">
                        ...
                        <h3 className="text-md lg:text-lg font-semibold text-palette-2">Education</h3>
                    </div>
                ...
                {profileData?.profile?.certifications && profileData.profile.certifications.length > 0 && (
                    ...
                    >
                        <div className="flex items-center mb-3">
                            ...
                            <h3 className="text-md lg:text-lg font-semibold text-palette-2">Certifications</h3>
                        </div>
                ...
                >
                    <div className="flex items-center mb-3">
                        ...
                        <h3 className="text-md lg:text-lg font-semibold text-palette-2">Connect</h3>
                    </div>
                ...
                >
                    ...
                    <p className="text-sm">
                        {profileData?.profile?.bio || "I grew up in the beautiful state of Rajasthan. Even though it's not known as a technical hub, I was always curious about how technology works. Throughout my journey, I focused on understanding systems deeply rather than just using them. Today, I enjoy building clean and efficient software, working with machines, and constantly learning. I love my machines, I love technology — it's not just my work, it's my passion."}
                    </p>
                </motion.div>
                ...
                >
                    <div className="flex items-center mb-2">
                        ...
                        <h3 className="text-md lg:text-lg font-semibold whitespace-nowrap">
                            {profileData?.profile?.education?.[0]?.degree || "Master of Computer Applications"}
                        </h3>
                    </div>
                    <div className="flex items-center justify-between text-sm">
                        <p>{profileData?.profile?.education?.[0]?.institution || "Savitribai Phule Pune University"}</p>
                ...
                {stats && (
                    ...
                    >
                        <div className="flex items-center mb-2">
                            ...
                            <h3 className="text-2xl font-bold text-palette-2">Total Coding Time</h3>
                        </div>
                        <WakaTimeTotalTimeCard weeklyTotalTime={stats.weekly_human_readable_total || "0 mins"} />
                    </motion.div>
                )}
                ...
                {stats && (
                    ...
                    >
                        <div className="flex items-center mb-2">
                            ...
                            <h3 className="text-md lg:text-lg font-semibold text-palette-2">Daily Average</h3>
                        </div>
                        <WakaTimeDailyAverageCard average={stats.weekly_human_readable_daily_average || "0 mins"} />
                    </motion.div>
                )}
                ...
                {stats && (
                    ...
                    >
                        <div className="flex items-center mb-2">
                            ...
                            <h3 className="text-md lg:text-lg font-semibold text-palette-2">Best Day</h3>
                        </div>
                        <WakaTimeBestDayCard
                ...
                {profileData?.statistics && (
                    ...
                    >
                        <div className="flex items-center mb-3">
                            ...
                            <h3 className="text-md lg:text-lg font-semibold text-palette-2">Profile Stats</h3>
                        </div>
                ...
                {stats && (
                    ...
                    >
                        <div className="flex items-center mb-2">
                            ...
                            <h3 className="text-md lg:text-lg font-semibold text-palette-2">Top Languages</h3>
                        </div>
                ...
                {stats && (
                    ...
                    >
                        <div className="flex items-center mb-2">
                            ...
                            <h3 className="text-md lg:text-lg font-semibold text-palette-2">Editors</h3>
                        </div>
                ...
                {stats && (
                    ...
                    >
                        <div className="flex items-center mb-2">
                            ...
                            <h3 className="text-md lg:text-lg font-semibold text-palette-2">Operating Systems</h3>
                        </div>
                        <WakaTimeOperatingSystemsCard operatingSystems={stats.operating_systems || []} />
                    </motion.div>
                )}
                ...
                {stats && (
                    ...
                    >
                        <div className="flex items-center mb-2">
                            ...
                            <h3 className="text-md lg:text-lg font-semibold text-palette-2">Machines</h3>
                        </div>
                ...
                {stats && (
                    ...
                    >
                        <div className="flex items-center mb-2">
                            ...
                            <h3 className="text-md lg:text-lg font-semibold text-palette-2">Top Projects</h3>
                        </div>
                ...
                {stats && (
                    ...
                    >
                        <div className="flex items-center mb-2">
                            <BarChart3 className="h-6 w-6 mr-2 text-palette-4" />
                            <h3 className="text-md lg:text-lg font-semibold text-palette-2">Productivity</h3>
                        </div>
                        <WakaTimeProductivityCard productivityScore={stats.productivity_score || 0} />
                    </motion.div>
                )}
                ...
                {stats && (
                    ...
                    >
                        <div className="flex items-center mb-2">
                            <TrendingUp className="h-6 w-6 mr-2 text-palette-4" />
                            <h3 className="text-md lg:text-lg font-semibold text-palette-2">Focus Time</h3>
                        </div>
                        <WakaTimeFocusCard focusTimePercentage={stats.focus_time_percentage || 0} />
                    </motion.div>
                )}
                ...
                {stats && (
                    ...
                    >
                        <div className="flex items-center mb-2">
                            ...
                            <h3 className="text-md lg:text-lg font-semibold text-palette-2">Interruptions</h3>
                        </div>
                        <WakaTimeInterruptionsCard interruptionCount={stats.interruption_count || 0} />
                    </motion.div>
                )}
                ...
                {stats && (
                    ...
                    >
                        <div className="flex items-center mb-2">
                            <Palette className="h-6 w-6 mr-2 text-palette-4" />
                            <h3 className="text-md lg:text-lg font-semibold text-palette-2">Activity Categories</h3>
                        </div>
                ...
                {stats?.raw_data?.goals?.[0] && (
                    <motion.div
                        variants={cardVariants}
                        className="col-span-2 sm:col-span-4 md:col-span-6 rounded-lg p-4 bg-primary border border-palette-1 shadow-xl flex flex-col"
                    >
                        <div className="flex items-center justify-between mb-2">
                            <div className="flex items-center">
                                <Star className="h-6 w-6 mr-2 text-palette-4" />
                                <h3 className="text-md lg:text-lg font-semibold text-palette-2">Daily Goal Progress</h3>
                            </div>
                            <div className="text-xs text-palette-2/60">
                                {stats.raw_data.goals[0].status_percent_calculated || 0}% complete
                            </div>
                        </div>
