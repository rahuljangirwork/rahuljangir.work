...
export function Awards({
        ...
        <div className="relative z-10 text-center">
          {showIcon && (
            <div className="mb-1 flex justify-center text-center text-2xl">
              {<Star className="text-neutral-900 fill-primary dark:text-neutral-50" />}
            </div>
          )}
          {recipient && (
            <div className="text-neutral-900 mt-2 text-[14px] dark:text-neutral-50">{recipient}</div>
          )}
    ...
    return (
      ...
      >
        ...
        <div className="z-10 px-8 text-center">
          ...
          {/* Decorative Line */}
          <div className="bg-neutral-900 mx-auto my-3 h-[1px] w-40 dark:bg-neutral-50"></div>
          ...
          {/* Recipient */}
          {recipient && (
            <p className={cn("text-neutral-900/60 italic dark:text-neutral-50/60")}>{recipient}</p>
          )}
  ...
  if (variant === "certificate") {
    const Badge = () => (
      <svg
        ...
        viewBox="0 24"
      >
        <path d="m19 21-7-4-7 4V5a2 2 0 1 2-2h10a2 2v16z" />
      </svg>
    )
    return (
      <div
      ...
      >
        <div className="bg-white z-10 rounded-sm border border-neutral-200 p-6 px-8 text-center dark:bg-neutral-950 dark:border-neutral-800">
          <Badge />
          <h1
            className={cn(
          ...
          <p className="text-neutral-500 mt-4 mb-1 text-xs dark:text-neutral-400">
            This is to certify that
          </p>
          <h1
            className={cn(
              "text-neutral-900 mb-2 border-b text-xl font-semibold tracking-tight dark:text-neutral-50"
            )}
          >
            {recipient}
          </h1>

          <p className="text-neutral-500 mb-1 text-xs dark:text-neutral-400">{subtitle}</p>
      ...
      <div className={cn("", className)}>
        ...
        >
          ...
          <div className={cn("border-l px-3")}>
            <h1
              className={cn("text-neutral-900 text-4xl font-bold tracking-tight dark:text-neutral-50")}
            >
              {title}
            </h1>
            <h2 className={cn("text-neutral-500 text-md font-light dark:text-neutral-400")}>
              {subtitle}
            </h2>
    ...
    return (
      ...
      >
        <div className="relative text-center">
          ...
          <span
            className="text-neutral-900 absolute hidden text-7xl font-black tracking-tighter dark:block dark:text-neutral-50"
            style={{
          ...
          <span
            className="text-neutral-900 absolute block text-7xl font-black tracking-tighter dark:hidden dark:text-neutral-50"
            style={{
          ...
          <span
            className="text-neutral-900 relative text-7xl font-black tracking-tighter dark:text-neutral-50"
            style={{
  ...
  if (variant === "id-card") {
    return (
      <div className={cn("flex bg-white items-center rounded-md border border-neutral-200 shadow-lg p-1 justify-center dark:bg-neutral-950 dark:border-neutral-800", className)}>
        <div className="relative h-100 w-72 rounded-sm overflow-hidden border-4">
          ...
          <span className="absolute top-8 right-8 flex h-4 w-4  items-center justify-center">
            <span className="bg-neutral-900 absolute inline-flex h-full w-full animate-ping rounded-full opacity-75 dark:bg-neutral-50"></span>
            <span className="bg-neutral-900 relative inline-flex h-3 w-3 rounded-full dark:bg-neutral-50"></span>
          </span>

          <div className="mt-24 px-6">
            <div
              className={cn(
                "bg-neutral-100 mb-4 w-fit rounded-md border border-neutral-200 px-4 py-2 text-xs dark:bg-neutral-800 dark:border-neutral-800"
              )}
            >
              {date}
            </div>
            <h1 className="text-5xl leading-tight font-bold">{title}</h1> 
            <p className="text-neutral-500 -mt-2 text-md font-light tracking-wider dark:text-neutral-400">
              {subtitle}
            </p>
          </div>
          <div className="absolute bottom-6 w-full border-t">
            <div className="mt-6 flex justify-between px-6">
              <div>
                ...
                <div className="text-neutral-900 text-lg font-semibold dark:text-neutral-50">
                  {description}
                </div>
              </div>
              <div className="p-3"> 
