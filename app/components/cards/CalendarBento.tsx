...
export function CalendarBento() {
  ...
  const bookingLink = `https://cal.com/rahuljangirwork/30min?month=${currentYear}-${(
    currentDate.getMonth() + 1
  )
    .toString()
    .padStart(2, "0")}`;
  ...
  return (
    <BentoCard height="h-[220px]" linkTo={bookingLink}>
      ...
      <div className="col-span-5 text-balance md:col-span-5">
          <h2 className="mb-4 text-base font-medium text-palette-2">
            Book a call with me
          </h2>
          <p className="mb-2 text-palette-3">
        ...
        <div className="absolute left-[43%] top-7 transition-all duration-500 ease-out md:-right-14 md:left-auto md:group-hover:-right-12 md:group-hover:top-5">
          <div>
            <div className="h-[278px] w-[550px] rounded-[20px] border border-border-primary p-2 transition-colors duration-100 group-hover:border-palette-4">
              <div
                className="h-full rounded-xl border-2 border-palette-1/20 bg-palette-3 p-3"
